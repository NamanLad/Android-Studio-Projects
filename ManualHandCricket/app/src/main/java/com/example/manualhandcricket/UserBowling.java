...
public class UserBowling extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_user_bowling);
        ...
        */
        ...
        Intent BowlingBegins = getIntent();
        batFirst = BowlingBegins.getBooleanExtra("Boolean", false);
        ...
        if(batFirst == true)
        {
            String target = BowlingBegins.getStringExtra("Target");
        ...
        final char[] value = {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k'};
        final Random r = new Random();


//        String target = intent1.getStringExtra("Target");
//        int val_target = Integer.parseInt(target);
//        val_target++;
//        target = Integer.toString(val_target);
        ...
        */
        code_btn_0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int random = r.nextInt(value.length);
...
//        final String target = code_tv_score.getText().toString();
        ...
        code_btn_next_newGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent GoToBatting = new Intent(UserBowling.this, MainActivity.class);

                GoToBatting.putExtra("Target", target);
                GoToBatting.putExtra("Boolean", batFirst);


                startActivity(GoToBatting);
    ...
    void computerWon()
    {
        ...
        code_btn_next_newGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent newGame = new Intent(UserBowling.this, Toss.class);
